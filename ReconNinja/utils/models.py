...
class ScanConfig:
    ...
    nmap_scripts:       Optional[str] = None   # comma-list or category
    confidence_min:     int           = 0      # filter below this %
...
class PortInfo:
    ...
    # v5.1.0 — scan intelligence
    confidence: int  = 100   # 0–100 service-detection confidence
    source:     str  = ""    # rustscan | async | masscan | nmap
...
class ReconResult:
    ...
    # v5.1.0 — new integrations
    censys_results:   list[dict]     = field(default_factory=list)
    hunter_results:   list[dict]     = field(default_factory=list)
    # v5.1.0 — diff
