...
BANNER
echo -e "${NC}"
echo -e "${BOLD}  ReconNinja v8.1.0 — Installer${NC}"
...
ALIAS_COMMENT="# ReconNinja v8.1.0 — https://github.com/ExploitCraft/ReconNinja"
...
if [[ -f "$HOME/.config/fish/config.fish" ]]; then
    ...
    if grep -q "alias ReconNinja" "$HOME/.config/fish/config.fish" 2>/dev/null; then
        ...
        { echo ""; echo "# ReconNinja v8.1.0"; echo "$FISH_ALIAS"; } \
...
#!/usr/bin/env bash
# ReconNinja v8.1.0 wrapper — auto-generated by install.sh
