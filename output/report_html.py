"""
output/report_html.py — ReconNinja  (version → see info/version)
  ...
  <div class="header-top">
    <div class="brand">
      ...
      <div class="brand-text">
        <h1>ReconNinja</h1>
        <div class="subtitle">v{__version__} // Automated Recon Framework</div>
      </div>
    </div>
...
<footer>
  <p>Generated by <a href="https://github.com/ExploitCraft/ReconNinja" target="_blank">ReconNinja v{__version__}</a>
  · {generated_at}
